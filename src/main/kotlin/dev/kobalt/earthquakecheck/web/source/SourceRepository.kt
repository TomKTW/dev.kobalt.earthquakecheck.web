...
package dev.kobalt.earthquakecheck.web.source
...
object SourceRepository {
    ...
    fun selectList(): List<Triple<String, String, String>> = listOf(
        Triple("dev.kobalt.earthquakecheck.android", "Application", "APK package of this application."),
        Triple("dev.kobalt.earthquakecheck.web", "Frontend", "Website server that provides this page.")
    )
