...
import dev.kobalt.earthquakecheck.web.about.AboutRepository
import dev.kobalt.earthquakecheck.web.download.DownloadRepository
import dev.kobalt.earthquakecheck.web.legal.LegalRepository
import dev.kobalt.earthquakecheck.web.source.SourceRepository

object IndexRepository {

    val pageTitle = "Index"
    val pageSubtitle = "Check the latest earthquakes that have occurred on Earth."
